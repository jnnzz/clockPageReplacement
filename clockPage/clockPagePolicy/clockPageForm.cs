...
{
    public partial class clockPageForm : Form
    {
        ...
        public clockPageForm()
        {
            InitializeComponent();
            InitializeUI();
            InitializeTimer();
            // Proper event attachment
            this.Paint += clockPageForm_Load;  // Correct paint handler
...
/// Animation for the timeLabel and pageRefLabel
        ...
        {
            // startButton.Enabled = false;
            Task animation1 = AnimateLabelAsync(panelDetails, 50, 100, 2000);
        ...
        private async void kryptonButton1_Click(object sender, EventArgs e)
        {
            ...
            AnimateButtonRatesClosing();
            AnimateTotalFaultClosing();
            AnimatePanelLegendClosing();
            await AnimateTimeLabelClosing();
            StartNewRequest();
        ...
        private void clockPageForm_Load(object sender, PaintEventArgs e)
        {
                ...
                topColor))
            {
                ...
                colorBlend.Positions = new float[] { 0f, 0.4f, 1f };
